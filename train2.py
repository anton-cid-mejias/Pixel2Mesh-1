...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('data_dir', '../data/figures', 'Data dir.') # training data list
flags.DEFINE_string('data_list', 'classes.csv', 'Data list.') # training data list
...
data = DataFetcher(FLAGS.data_dir, FLAGS.data_list)
data.setDaemon(True) ####
data.start()
